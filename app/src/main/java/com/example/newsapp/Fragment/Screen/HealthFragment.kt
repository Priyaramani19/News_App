...
class HealthFragment : Fragment() {
    ...
    lateinit var healthFragmentBinding: FragmentHealthBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        healthFragmentBinding = FragmentHealthBinding.inflate(inflater, container, false)
    ...
    fun getCountry() {
        ...
        apiInterface.getCountry("in", "health", "532a522ab79744f7a07aec970a5bdeaf").enqueue(object :
            ...
            override fun onResponse(call: Call<CountryModel>, response: Response<CountryModel>) {
                ...
                healthFragmentBinding.shimmerEffect.isVisible = false
    ...
    fun setUpRV(l1: List<com.example.newsapp.ModelClassAPI.ArticlesItem?>) {
        ...
        healthFragmentBinding.rvView.adapter = adapter
        healthFragmentBinding.rvView.layoutManager = layoutManager
    }
